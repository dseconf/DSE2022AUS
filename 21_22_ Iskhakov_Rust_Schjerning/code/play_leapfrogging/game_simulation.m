% game_simulation.m: simulates the play of the symmetric mixed strategy equilibrium 
%                    of the Bertrand investment game, with or without a human opponent
%                    at the keyboard.
%
%                    John Rust, Georgetown University, June, 2017
...
voice=0;  % 0 to turn voice off on mac

print_hist=0; %print game history in the end


% do not change any code below unless you know what you are doing!

if (robot_player ~= 1);
    [ir,v]=state_recursion;
end;
